<?php
    ...
    $id=$_GET['id'];
    $query="SELECT * FROM `lrsetitdomaine` WHERE `id`='$id' ";
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Mis à jour domaine de recherche</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <div class="card border-dark shadow p-3 mb-5 bg-body rounded">
            ...
            <div class="card-body text-dark">
                <form action="update_domaine.php?&id=<?=($id);?>" method="post" enctype="multipart/form-data">
                    <div class="col-sm-10 mt-3 mx-1">
                        <h1>Mis à jour domaine</h1>
                        <hr>
                        ...
                        <div class="form-group">
                            ...
                            <span class="obligatoryFieldMark">*</span>
                            <textarea class="form-control mt-2" name="description" rows="10" placeholder="Description"><?php echo($val_0);?></textarea>
                        </div>
