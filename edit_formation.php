<?php
    ...
    $id=$_GET['id'];
    $query="SELECT * FROM `lrsetitformation` WHERE `id`='$id' ";
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Mis à jour formation</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <div class="card border-dark shadow p-3 mb-5 bg-body rounded">
            ...
            <div class="card-body text-dark">
                <form action="update_formation.php?&id=<?=($id);?>" method="post" enctype="multipart/form-data">
                    <div class="col-sm-10 mt-3 mx-1">
                        <h1>Mis à jour formation</h1>
                        <hr>
                        ...
                        <div class="form-group">
                            ...
                            <span class="obligatoryFieldMark">*</span>
                            <input type="text" class="form-control mt-2" name="formateur" placeholder="Lieu" value="<?=$val_1;?>">
                        </div>
                        <div class="form-group">
