...
<div class="d-flex justify-content-center mt-3">
    <button class="btn btn-primary mx-2" onclick="showConf()">Conférences</button>
    <button class="btn btn-primary mx-2" onclick="showForm()">Formations</button>
    <button class="btn btn-primary mx-2" onclick="showEve()">Événements</button>
</div>
<div class="container">
          
            <div class="card border-secondary mt-5 shadow p-3 mb-5 bg-body rounded  wow fadeInDown" id="conf">
            ...
            <div class="card border-secondary mt-5 shadow p-3 mb-5 bg-body rounded  " id="form" style="display:none">
                    ...
                    <div class="table-responsive table" id="search" >
                        <table id="formation_table" class="table table-bordered table-striped" >
                            ...
                            <tr >
                                        <?php
                                          $i=1;
                                          while($row_formation=mysqli_fetch_array($result_formation)){
                                            $id=$row_formation['0'];
                                            
                                          ?>
                                          <td ><?php echo($i)?></td>
                                          <td ><?php echo (ucfirst($row_formation['1']) )?></td>
                                          <td><?php echo (ucfirst($row_formation['2']))?></td>
                                          <td><?php echo (ucfirst($row_formation['3'])) ?></td>
                                          <td><?php echo $row_formation['4'] ?></td>
                                          <td><?php echo $row_formation['5']?></td>
                                          <td><?php echo $row_formation['6'] ?></td>
            ...
            <div class="card border-secondary mt-5 shadow p-3 mb-5 bg-body rounded  " id="eve" style="display:none">
                <div class="card-header text-center fw-bold fs-4" style="color:#22577E">Événements</div>
                <div class="card-body ">
                    <div class="table-responsive table" id="search" >
                        <table id="evenement_table" class="table table-bordered table-striped" >
                            <thead  class="table-primary  ">
                                <tr>
                                        <th >#</th>
                                        <th>Titre</th>
                            ...
                            <tr >
                                        <?php
                                          $i=1;
                                          while($row_evenement=mysqli_fetch_array($result_evenement)){
                                            $id=$row_evenement['0'];
                                            
                                          ?>
                                          <td ><?php echo($i)?></td>
                                          <td ><?php echo (ucfirst($row_evenement['1']) )?></td>
                                          <td><?php echo (ucfirst($row_evenement['2']))?></td>
                                          <td><?php echo (ucfirst($row_evenement['3'])) ?></td>
                                          <td><?php echo $row_evenement['4'] ?></td>
                                          <td><?php echo $row_evenement['5']?></td>
                                          <td><?php echo $row_evenement['6'] ?></td>
