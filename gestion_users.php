<?php
    ...
    $query="SELECT * FROM `lrsetitutilisateur` WHERE `existe` = 1 " ;
        ...
        <div class="row mb-2">
          <div class="col-sm-3">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="ajout_user.php" target="_blank" class="small-box-footer">AJOUT <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div><!-- /.col -->
          <div class="col-sm-9">
                  ...
                  <div class="row">
                    <div class="col-7">
                      ...
                      <ul class="ml-2 mb-0  fa-ul text-muted">
                        <li class="small"><span class="fa-li"><i class="fa fa-envelope" aria-hidden="true"></i> </span>Mail : <?php echo($row['3']); ?></li>
                        <li class="small mt-2"><span class="fa-li"><i class="fa fa-phone" aria-hidden="true"></i> </span> Phone #: <?php echo($row['6']);?></li>
                      </ul>
                    </div>
