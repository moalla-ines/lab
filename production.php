...
$query_cooperation="SELECT * FROM `lrsetitcooperation` " ;
$result_cooperation=mysqli_query($con,$query_cooperation);

$query_visiteur="SELECT * FROM `lrsetitauteur_projet` WHERE approve='1'";
...
<div class="d-flex justify-content-center mt-3">
    <button class="btn btn-primary mx-2" onclick="showProd()">Productions scientifiques</button>
    <button class="btn btn-primary mx-2" onclick="showCoop()">Coopération</button>
</div>

<div class="container">
          
            <div class="card border-secondary mt-5 shadow p-3 mb-5 bg-body rounded  wow fadeInDown" id="prod" >
                <div class="card-header text-center fw-bold fs-4" style="color:#22577E">Productions scientifiques</div>
                            ...
                            <tr >
                                        <?php
                                         if(isset($_SESSION['mail'])){
                                          ...
                                          <td><a href="description_production.php?id_papier=<?=($id_papier);?>&type=<?=($tab);?>&id=<?=($id);?>" target="blank_"><button type="button" class="btn btn-primary openBtn" >Description</button></a></td>
                                      </tr>
                                      <?php
                                      $i++;
                                          }
              ...
              <div class="card border-secondary mt-5 shadow p-3 mb-5 bg-body rounded  " id="coop" style="display:none">
                  <div class="card-header text-center fw-bold fs-4" style="color:#22577E">Coopérations</div>
                  <div class="card-body ">
                      <div class="table-responsive table" id="search" >
                          <table id="cooperation_table" class="table table-bordered table-striped" >
                              <thead  class="table-primary  ">
                                  <tr>
                                      <th >#</th>
                                      <th>Type</th>
                              ...
                              <tr >
                                          <?php
                                            $i=1;
                                            while($row_cooperation=mysqli_fetch_array($result_cooperation)){
                                              $id=$row_cooperation['0'];
                                              
                                            ?>
                                            <td ><?php echo($i)?></td>
                                            <td ><?php echo (ucfirst($row_cooperation['1']) )?></td>
                                            <td><?php echo (ucfirst($row_cooperation['2']))?></td>
                                            <td><?php echo ucwords($row_cooperation['3']) ?></td>
                                            <td><?php echo $row_cooperation['4'] ?></td>
                                            <td><?php echo $row_cooperation['5']?></td>
                                            <td><?php echo $row_cooperation['6'] ?></td>
