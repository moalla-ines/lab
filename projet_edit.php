...
$id=$_GET['id'];
$etat=$_SESSION['etat'];
$query="SELECT * FROM `lrsetit$tab` WHERE `id`='$id_projet' ";
...
<div class="row">
  ...
  <div class="col-9">
    <div class="card border-dark shadow p-3 mb-5 bg-body rounded" >
        ...
        ?>
        <div id="these" >
          <form action="update_these.php?id_projet=<?=($id_projet);?>&id=<?=($id);?>" method="post" enctype="multipart/form-data">
            <div class="col-sm-10 mt-3 mx-2">
              ...
              <div class="form-group">
                ...
                <span class="obligatoryFieldMark">*</span>
                <input type="number" class="form-control mt-2" name="anneeinscri" value="<?=$val_3;?>">
              </div><br>
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <span class="obligatoryFieldMark">*</span>
                    <input type="text" name="encadrant" class="form-control mt-2 " placeholder="Encadrant" value="<?=$val_4;?>">
                  </div>
                  <div class="col-sm-6 form-group">
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <input type="text" name="encadrant_2" class="form-control mt-2 " placeholder="Encadrant" value="<?=$val_6;?>">
                  </div>
                  <div class="col-sm-6 form-group">
                    <label class="control-label fw-bold">Mail encadrant</label>
        ...
        ?>
        <div id="hab">
          <form action="update_habilitation.php?id_projet=<?=($id_projet);?>&id=<?=($id);?>" method="post" enctype="multipart/form-data">
            <div class="col-sm-10 mt-3 mx-2">
                  <h1>Habilitation</h1>
                  <hr>
                  ...
                  <div class="from-group">
                    ...
                    <div class="form-group">
                      ...
                      <span class="obligatoryFieldMark">*</span>
                      <input type="text" class="form-control mt-2" name="nom" placeholder="Nom et prénom" value="<?=$val_0;?>">
                    </div><br>
                    <div class="form-group">
                        <label class="fw-bold">Année</label>
                        <span class="obligatoryFieldMark">*</span>
                    ...
                    <div class="form-group">
                      <div class="row">
                        <div class="col-sm-6 form-group">
                          <label class="control-label fw-bold">Encadrant</label>
                          <span class="obligatoryFieldMark">*</span>
                          <input type="text" name="encadrant" class="form-control mt-2 " placeholder="Encadrant" value="<?=$val_3;?>">
                        </div>
                        <div class="col-sm-6 form-group">
                          <label class="control-label fw-bold">Mail encadrant</label>
                          <span class="obligatoryFieldMark">*</span>
                    ...
                    <div class="form-group">
                      ...
                      <span class="obligatoryFieldMark">*</span>
                      <input type="date" class="form-control mt-2" name="date" value="<?=$val_4;?>">
                    </div><br>
        ...
        ?>
        <div id="pfe">
          <form action="update_pfe.php?id_projet=<?=($id_projet);?>&id=<?=($id);?>" method="post" enctype="multipart/form-data">
            <div class="col-sm-10 mt-3 mx-2">   
                  <h1>PFE</h1>
                  <hr>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="description" class="form-control mt-2" cols="20" rows="5" value="<?=$val_1;?>"><?php echo($val_1);?></textarea>
                  </div><br>
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-6 form-group">
                        <label class="control-label fw-bold">Encadrant</label>
                        <span class="obligatoryFieldMark">*</span>
                        <input type="text" name="encadrant" class="form-control mt-2 " placeholder="Encadrant" value="<?=$val_2;?>">
                      </div>
                      <div class="col-sm-6 form-group">
                        <label class="control-label fw-bold">Mail encadrant</label>
                        <span class="obligatoryFieldMark">*</span>
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-6 form-group">
                        <label class="control-label fw-bold">Deuxième encadrant</label>
                        <input type="text" name="encadrant_2" class="form-control mt-2 " placeholder="Encadrant" value="<?=$val_3;?>">
                      </div>
                      <div class="col-sm-6 form-group">
                        <label class="control-label fw-bold">Mail encadrant</label>
                        <input type="text" name="mail_encadrant_2" class="form-control mt-2 " placeholder="Mail">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="institut" class="form-control mt-2" placeholder="Institution" value="<?=$val_4;?>">
                  </div><br>
                  <div class="form-group">
                    <label class="fw-bold">Etudiant</label>
                    <input type="text" name="etudiant" class="form-control mt-2" placeholder="Etudiant" value="<?=$val_5;?>">
                  </div><br>
                  <div class="form-group">
                  <label class="fw-bold">Date debut de PFE</label>
                  <input type="date" name="debut" id="debut" class="form-control mt-2" value="<?=$val_6;?>">
                  </div><br>
                  <div class="form-group">
                  <label class="fw-bold">Date fin de PFE</label>
                  <input type="date" name="fin" id="fin" class="form-control mt-2" value="<?=$val_7;?>">
                  </div><br>
                  <div class="d-flex justify-content-center">
                      <button type="submit" class="btn btn-outline-success mb-3 w-25" value="upload" id="submit" name="update"  onclick="sweet()">Update</button> 
                    </div>
