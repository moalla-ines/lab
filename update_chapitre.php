...
if(isset($_POST['update'])){
    ...
    if (isset($_POST['titre']) && $_POST['titre'] !== "") {
        ...
        $titre_query="UPDATE `lrsetitchapitre d'ouvrage` SET `Titre`='$titre' WHERE `id`='$id_papier'";
    ...
    if (isset($_POST['editeur']) && $_POST['editeur'] !== "") {
        ...
        $editeur_query="UPDATE `lrsetitchapitre d'ouvrage` SET `Editeur`='$editeur' WHERE `id`='$id_papier'";
    ...
    if (isset($_POST['date']) && $_POST['date'] !== "") {
        ...
        $date_query="UPDATE `lrsetitchapitre d'ouvrage` SET `Date`='$date' WHERE `id`='$id_papier'";
    ...
    if (isset($_POST['lien']) && $_POST['lien'] !== "") {
        ...
        $lien_query="UPDATE `lrsetitchapitre d'ouvrage` SET `Lien editeur`='$lien' WHERE `id`='$id_papier'";
    ...
    if (isset($_POST['edition']) && $_POST['edition'] !== "") {
        ...
        $edition_query="UPDATE `lrsetitchapitre d'ouvrage` SET `Edition`='$edition' WHERE `id`='$id_papier'";
    ...
    if (isset($_POST['isbn']) && $_POST['isbn'] !== "") {
        ...
        $isbn_query="UPDATE `lrsetitchapitre d'ouvrage` SET `ISBN/Issn`='$isbn' WHERE `id`='$id_papier'";
        
        mysqli_query($con,$isbn_query);
    }

    $_SESSION['status']="Mise à jour chapitre réussie ! " ;
