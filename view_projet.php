...
$query="SELECT * FROM `lrsetitauteur_projet` WHERE `soumissionnaire`= '$mail' OR `mail_encadrant` LIKE '%$mail%' " ;
            ...
            $.ajax({
              ...
              success: function (response) {
                if(response==200)
                {
                  Swal.fire(
                  'Supprimé!',
                  'La production scientifque est bien supprimé',
                  'success'
                ).then((result) => {
                  location.reload();
                }).catch((err) => {
                ...
                }else if(respons ==500)
                {
                  Swal.fire({
                      icon: 'error',
                      title: 'Erreur',
                      text: 'Production scientifque non supprimé!',
                    })
                }
              }
          });
